...
import photo1 from "../assets/comups1.png";
import photo2 from "../assets/comups2.jpg";
...
const ComUps = () => {
    ...
    const images = [
        { src: photo1, alt: "Commercial Ups 1" },
        { src: photo2, alt: "Commercial Ups 2" },
    ];
            ...
            <div className="flex flex-col md:flex-row mt-4 p-4 space-y-4 md:space-y-0 md:space-x-6">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center w-full">
                    ...
                    <div className="flex flex-col space-y-4 md:w-1/2 text-gray-800 md:pl-6 px-2 md:px-0">
                        <h1 className="text-2xl font-bold">Advanced Commercial UPS Systems</h1>
                        <p className="text-lg">
                            <strong>Brand:</strong> Microtek, Luminous
                        </p>
                        <p>
                        Elevate your business continuity with our advanced commercial UPS systems, offering seamless power backup.
                        </p>
                        <ul className="list-disc pl-4">
                            <li>Heavy-duty performance</li>
                            <li>Comprehensive surge protection</li>
                            <li>User-friendly operation</li>
                            <li>Energy-saving design</li>
                            <li>Protection for sensitive electronics</li>
