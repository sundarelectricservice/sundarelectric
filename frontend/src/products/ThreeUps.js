...
import photo1 from "../assets/three1.webp";
import photo2 from "../assets/three2.webp";
...
const ThreeUps = () => {
    ...
    const images = [
        { src: photo1, alt: "Three-Phase Online UPS 1" },
        { src: photo2, alt: "Three-Phase Online UPS 2" },
    ];
            ...
            <div className="flex flex-col md:flex-row mt-4 p-4 space-y-4 md:space-y-0 md:space-x-6">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center w-full">
                    ...
                    <div className="flex flex-col space-y-4 md:w-1/2 text-gray-800 md:pl-6 px-2 md:px-0">
                        <h1 className="text-2xl font-bold">Three-Phase Online UPS Systems</h1>
                        <p className="text-lg">
                            <strong>Brand:</strong> Fuji Electric, Microtek, Numeric, APC, Vertive (Emerson), Luminous, UTL, Delta
                        </p>
                        <p>
                        Our three-phase online UPS systems cater to large-scale industrial and commercial needs.
                        </p>
                        <ul className="list-disc pl-4">
                            <li>Superior load capacity and stability</li>
                            <li>Smooth and efficient power delivery</li>
                            <li>Advanced protection from power fluctuations</li>
                            <li>Robust and reliable construction</li>
                            <li>Suitable for demanding operational environments</li>
                        </ul>
