...
import photo1 from "../assets/iso1.webp";
import photo2 from "../assets/iso2.webp";
import Footer from "../containers/Footer";
import { Link } from "react-router-dom";
import ContactModal from "../components/ContactModal";

const IsolationTrans = () => {
    const [selectedImage, setSelectedImage] = useState(photo1);
    const [createContactModalOpen, setContactModalOpen] = useState(false);

    const images = [
        { src: photo1, alt: "Isolation Transformers 1" },
        { src: photo2, alt: "Isolation Transformers 2" },
    ];
            ...
            <div className="flex flex-col md:flex-row mt-4 p-4 space-y-4 md:space-y-0 md:space-x-6">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center w-full">
                    ...
                    <div className="flex flex-col space-y-4 md:w-1/2 text-gray-800 md:pl-6 px-2 md:px-0">
                        <h1 className="text-2xl font-bold">Reliable Isolation Transformers</h1>
                        <p className="text-lg">
                            <strong>Brand:</strong> Fuji Electric, Servocom, Sentronics
                        </p>
                        <p>
                        Our isolation transformers ensure safety and noise reduction for sensitive equipment.
                        </p>
                        <ul className="list-disc pl-4">
                            <li>Effective protection from electrical noise</li>
                            <li>Excellent voltage regulation capabilities</li>
                            <li>Compact and sturdy build</li>
                            <li>High operational efficiency</li>
                            <li>Ideal for critical industrial applications</li>
                        </ul>
