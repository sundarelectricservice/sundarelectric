...
import photo1 from "../assets/ups1.jpg";
import photo2 from "../assets/ups2.jpg";
...
const UpsBatteries = () => {
    ...
    const images = [
        { src: photo1, alt: "Premium UPS & Tubular Batteries 1" },
        { src: photo2, alt: "Premium UPS & Tubular Batteries 2" },
    ];
            ...
            <div className="flex flex-col md:flex-row mt-4 p-4 space-y-4 md:space-y-0 md:space-x-6">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center w-full">
                    ...
                    <div className="flex flex-col space-y-4 md:w-1/2 text-gray-800 md:pl-6 px-2 md:px-0">
                        <h1 className="text-2xl font-bold">Premium UPS & Tubular Batteries</h1>
                        <p className="text-lg">
                            <strong>Brand:</strong> Microtek, Luminous, Exide Batteries, Autobat Batteries
                        </p>
                        <p>
                        Experience uninterrupted power with our premium range of UPS and tubular batteries, designed for both residential and commercial applications.
                        </p>
                        <ul className="list-disc pl-4">
                            <li>Reliable and consistent power backup</li>
