...
import photo1 from "../assets/vol1.webp";
import photo2 from "../assets/vol2.webp";
import Footer from "../containers/Footer";
import { Link } from "react-router-dom";
import ContactModal from "../components/ContactModal";

const VoltageStabilizer = () => {
    const [selectedImage, setSelectedImage] = useState(photo1);
    const [createContactModalOpen, setContactModalOpen] = useState(false);

    const images = [
        { src: photo1, alt: "Voltage Stabilizers 1" },
        { src: photo2, alt: "Voltage Stabilizers 2" },
    ];
            ...
            <div className="flex flex-col md:flex-row mt-4 p-4 space-y-4 md:space-y-0 md:space-x-6">
                ...
                <div className="flex flex-col md:flex-row items-start md:items-center w-full">
                    ...
                    <div className="flex flex-col space-y-4 md:w-1/2 text-gray-800 md:pl-6 px-2 md:px-0">
                        <h1 className="text-2xl font-bold">Smart Voltage Stabilizers</h1>
                        <p className="text-lg">
                            <strong>Brand:</strong> Fuji Electric, Servocom, Sentronics
                        </p>
                        <p>
                        Safeguard your appliances with our smart voltage stabilizers, engineered for consistent voltage control.
                        </p>
                        <ul className="list-disc pl-4">
                            <li>Reliable voltage regulation</li>
                            <li>Protection from power surges</li>
                            <li>Enhanced durability and appliance longevity</li>
                            <li>Easy installation and user-friendly design</li>
                            <li>Optimal performance under fluctuating conditions</li>
                        </ul>
...
export default VoltageStabilizer;
